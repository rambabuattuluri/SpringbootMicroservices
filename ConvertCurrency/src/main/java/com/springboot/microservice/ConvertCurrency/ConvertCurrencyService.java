...
public class ConvertCurrencyService {
	...
	public ConvertCurrencyBean retrieveConversionFactor(String fromCountryCode) {
		ResponseEntity<ConvertCurrencyBean>responseEntity=template.getForEntity("http://localhost:9000/getConversionFactor/fromCountryCode/{fromCountryCode}", ConvertCurrencyBean.class, fromCountryCode);  
