...
public class ConvertCurrencyService {
	...
	public ConvertCurrencyBean retrieveConversionFactor(String fromCountryCode) {
		ResponseEntity<ConvertCurrencyBean>responseEntity=template.getForEntity("http://localhost:9080/MS1/getConversionFactor/{fromCountryCode}", ConvertCurrencyBean.class, fromCountryCode);  
